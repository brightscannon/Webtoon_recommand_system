...
### ◆ 2018-10-16(Tue)
> #### 주제 : 이미지 분석 품질평가 및 추천시스템화
>  (장소 : 스타벅스 리저브 이수역 2번출구)
>  - **추천시스템 설계 및 구현**
>    1. 기존 AWS EC2의 Flask에서 서비스 제공하는것을 기본 골자로 하고, 일단 베이스 디자인 만들어보기로 결정
>    2. 다음주에 더 해보기로함
>  - **썸네일 이미지 분류 신경망을 활용한 웹툰간 이미지 유사도 측정모델**
>    - 현재 Hub활용한 유사도 측정방식 진행중
>    - CNN(VGGNet 응용)을 통한 softmax proba로 유사도 모델 시험 및 개선중
>  - `대분류 분석 종류`
>    - 성향 : [X]장르/키워드, [X]썸네일이미지, [ ]댓글유사도, [ ][댓글이용자유사도]
>    - 품질 : 추천(댓수)경향성, 추천반응, 별점평균, [댓글감정])
